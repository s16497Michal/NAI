...
# Do uruchomienia programu wykorzystujemy komendę w terminalu: python diabetes.py
...
model = tf.keras.Sequential([
  feature_layer,
  layers.Dense(256, activation='relu'), # first layer with 256 neurons
...
# Wnioski z porównania z poprzednim ćwiczeniem na tym samym zbiorze danych:
# -Uczenie sieci neuronej trwa dłużej
# -Predykcja jest bardziej dokładna dla sieci neuronowych